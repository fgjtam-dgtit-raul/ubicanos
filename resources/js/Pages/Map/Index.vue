...
const municipalitySelected = ref({});
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class=" max-w-screen-2xl mx-auto p-2 w-full h-full grid gap-2" style="grid-template-columns: 24rem 1fr; grid-template-rows: 1fr 8rem;">
            ...
            <div class="outline outline-1 outline-gray-200 rounded-lg bg-emerald-100 overflow-clip row-span-2">
                <div id="map" class="w-full h-full" />
            </div>

            <div v-if="municipalitySelected" class="outline outline-1 opacity-50 outline-gray-200 rounded-lg bg-blue-100 absolute bottom-0 right-0 m-4 flex flex-col gap-2" style="z-index: 999;">
                <div class="flex">
                ...
                <div v-for="key in Object.keys(municipalitySelected)" class="flex gap-2 border-b-2 border-gray-500">
                    <div>{{ key }}</div>
